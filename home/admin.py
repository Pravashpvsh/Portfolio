...
from .models import Hero,Abouts,Client,socialplatform,contact,Skill,Testimonial,services,skiill_description,cSkill,sdescription,Project,Summary, ProfessionalExperience, Education,Message
